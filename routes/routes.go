...
func SetupRouter() *gin.Engine {
	...
	route.GET("ems/cmp/tps", controllers.GetTotalTPSController)
	route.GET("ems/users/tps", controllers.GetUsersTPSController)
	route.GET("ems/telcoApi/tps", controllers.GetTelCoApiTPSController)
	route.GET("ems/telcoJob/tps", controllers.GetTelcoJobTPSController)
	route.GET("ems/vtPricing/tps", controllers.GetVtPricingTPSController)
	route.GET("ems/MiniOvt/tps", controllers.GetMiniOvtTPSController)
	...
	route.GET("ems/kpi//request/cmp", controllers.GetKpiCmpController)
	route.GET("ems/kpi/vtrack/downtime", controllers.GetKpiDowntimeController)
	route.GET("ems/kpi/latency/vtrack", controllers.GetKpiLatencyVtrackController)
	route.GET("ems/kpi/latency/db", controllers.GetCMPKpiLatencyDBController)
	route.GET("ems/kpi/latency/dbtotal", controllers.GetKpiLatencyDBTotalController)
	route.GET("ems/kpi/latency/dblogin", controllers.GetKpiLatencyDBLoginController)
	route.GET("ems/kpi/latency/dbimage", controllers.GetKpiLatencyDBGetImageController)
	route.GET("ems/kpi/latency/dbreport", controllers.GetKpiLatencyDBReportController)
	route.GET("ems/kpi/latency/dbtrack", controllers.GetKpiLatencyDBTrackingController)
	route.GET("ems/kpi/request/db", controllers.GetKpiRequestDBController)
	route.GET("ems/kpi/request/dbtotal", controllers.GetKpiRequestDBTotalController)
	route.GET("ems/kpi/request/dblogin", controllers.GetKpiRequestDBLoginController)
	route.GET("ems/kpi/request/dbreport", controllers.GetKpiRequestDBReportController)
	route.GET("ems/kpi/request/dbimage", controllers.GetKpiRequestDBGetImagesController)
	route.GET("ems/kpi/request/dbtrack", controllers.GetKpiRequestDBTrackingController)
