...
// SystemAvailability mirrors the system_availability table structure.
// ts/window describe the aggregation window; latency percentiles are optional
// and can be left nil if not available from the data source.
...
// InsertSystemAvailability stores a single availability snapshot.
